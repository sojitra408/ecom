							...
							{{ method_field('PUT') }}
								...
								<div class="col-lg-offset-3 col-lg-6">
									...
									<div class="form-group">
										...
										<input type="text" disabled="disabled" class="form-control" id="email" name="email" placeholder="email" value="@if (old('email')){{ old('email') }}@else{{ $user->email }}@endif">
									</div>
								...
								<div class="form-group">
									...
									<a href='{{ route('user.display') }}' class="btn btn-warning">Back</a>
								</div>
