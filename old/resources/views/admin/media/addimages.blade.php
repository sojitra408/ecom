        ...
        <div class="row">
            <div class="col-md-12">
              ...
              <div class="alert alert-success alert-dismissible fade show" role="alert">
                  ...
                  <span class="sr-only">Uploaded Success!</span>
            ...
            <div class="modal-dialog">
                ...
                <div class="modal-content">
                    ...
                    <div class="modal-body">
					 ...
					 <form action="{{ url('admin/media/uploadimageNew') }}" method="post" enctype="multipart/form-data"
                             >
                            {{ csrf_field() }}
							<input type="file" name="file"  accept=".gif,.png,.jpg,.jpeg" id="image"  />
						<img id="preview"  style="display:none"
                         src="{{asset('public/img/noimage.jpg')}}  "
            ...
            <div class="modal-dialog" role="document">
                <div class="modal-content">
                    <div class="modal-header">
					 ...
					 <form action="{{ url('admin/deleteimage') }}" method="post"  class="form-horizontal" enctype="multipart/form-data"
