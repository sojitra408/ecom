<head>
  ...
  <!-- Bootstrap 3.3.6 -->
  <link href="{!! secure_asset('public/admin/vendor/bootstrap/css/bootstrap.min.css') !!}" media="all" rel="stylesheet" type="text/css" />
  <link href="{!! secure_asset('public/admin/vendor/bootstrap/css/styles.css') !!}" media="all" rel="stylesheet" type="text/css" />
