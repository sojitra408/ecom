...
<div class="col-md-9">
          ...
          <div class="card shadow mb-4">
            ...
            <div class="peer mt-2">
                        <form action="{{route('saveFoodcatstoperBranddelete')}}" class="actionDelete" method="post">
 ...
 Delete all selected Fashion Category</button>
            ...
            <form role="form" action="{{ route('single.update',2) }}" method="post">
	          {{ csrf_field() }}
                ...
                <table class="table table-bordered" id="foodcategorystopers_table" style="width:100%">
                    <thead> 
                    <th>Id </th>                   
                    <th>Brand Name</th> 
...
function checkboxSelect(id) {
      ...
      $("#overlay").fadeIn(300);
		...
		$.ajax({
		   type:'POST',
		   url:"{{ route('saveFoodcatstoperBrand') }}",
		   data:{
