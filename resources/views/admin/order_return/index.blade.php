...
@section('content')
        ...
        <div class="container-fluid">
          ...
          <!-- Page Heading -->
          <h1 class="h3 mb-2 text-gray-800">All Orders Return</h1>
                    ...
                    <?php if(count($orders)>0){
                        ...
                        foreach($orders as $ord){?>
                            <tr>
								...
								<td>@if($ord->order_status==0)Pending @elseif($ord->order_status==1)Received @elseif($ord->order_status==2)Cancel @endif</td>
                                <td>
                                ...
                                <a href="{{route('order.delete',$ord->id)}}" class="btn btn-danger btn-sm"><i class="fas fa-trash"></i></a>
                            @endif</td>
                            </tr>
                        <?php $i++; }
                    }else{?>
