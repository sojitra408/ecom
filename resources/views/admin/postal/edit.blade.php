...
@section('content')
        ...
        <div class="container-fluid">
          ...
          <!-- Page Heading -->
          <h1 class="h3 mb-2 text-gray-800">Edit Posatlcode</h1>
         

          <!-- DataTales Example -->
          <div class="card shadow mb-4">
            <div class="card-header py-3">
              <h6 class="m-0 font-weight-bold text-primary">Posatlcode</h6>
            </div>
            <form role="form" action="{{ route('postal.update',$project->id) }}" method="post">
	          ...
	          {{ csrf_field() }}
	            ...
	            <div class=" col-lg-8 py-2">
                  ...
                  <label for="name">Posatlcode Code</label>
                  <input type="text" class="form-control" id="postalcode" name="postalcode"  value="{{ $project->postalcode }}">
                </div>
	...
	<div class="form-group">
                  ...
                  <div class="type">
					...
					<option value="COD" <?php echo ($project->postcode_type== 'COD')?'selected="selected"':''?>
                     >COD</option>
					<option value="PREPAID" <?php echo ($project->postcode_type == 'PREPAID')?'selected="selected"':''?>>PREPAID</option>
					</select>
                  </div>
                </div>
                ...
                @if(Auth::user()->can('postalcode-management-edit'))
