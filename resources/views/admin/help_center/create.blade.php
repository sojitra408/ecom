...
@section('content')
        <div class="container-fluid">
          ...
          <!-- Page Heading -->
          <h1 class="h3 mb-2 text-gray-800">Add Help Center</h1>
          ...
          <div class="card shadow mb-4">
            ...
            <form role="form" action="{{route('help_center.store')}}" method="post">
	          {{ csrf_field() }}
	              <div class="box-body">
                ...
                <div class="form-group">
                  ...
                  <textarea class="form-control" id="long_description" rows="3" name="answer" value="{{ old('answer') }}"></textarea>
                  <!-- <input type="text" class="form-control" id="answer" name="answer" placeholder="Answer" value="{{ old('answer') }}"> -->
                </div>
