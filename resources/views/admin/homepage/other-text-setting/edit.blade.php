...
<div class="col-md-9">
          ...
          <div class="card shadow mb-4">
            ...
            <form role="form" action="{{ route('home.other-text-setting.update',$single->id) }}" method="post">
	          {{ csrf_field() }}
	              <div class="box-body">
	            ...
	            <div class="form-group">
	              ...
	              <a href="{{route('home.other-text-setting.index')}}" class="btn btn-warning btn-sm">Back</a>
	            </div>
