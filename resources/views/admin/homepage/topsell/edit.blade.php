...
<div class="col-md-9">
          ...
          <div class="card shadow mb-4">
            <div class="card-header py-3">
             ...
             <div class="peer mt-2">
                        <form action="{{route('deletehometopsell')}}" class="actionDelete" method="post">
	...
	@endforeach
            ...
            <form role="form" action="#" method="post">
	          {{ csrf_field() }}
                ...
                <table class="table table-bordered" id="top_sell_table" style="width:100%">
                    <thead> 
                    <th>Id</th>
                    <th>Category Name</th>
