...
<div class="col-md-9">
          ...
          <div class="card shadow mb-4">
            <div class="card-header py-3">
              <h6 class="m-0 font-weight-bold text-primary">Head Turners Product</h6>
            </div>
             <div class="peer mt-2">
                        <form action="{{route('deletehomeTurners')}}" class="actionDelete" method="post">
            ...
            <form role="form" action="#" method="post">
	          {{ csrf_field() }}
	           ...
	           <!-- <div class="form-group">
				<input id="mytext" type="hidden" name="mytext">
...
$('#category_id').change(function(){
	...
	/* var checkboxValues = [];
 $(document).on('change',".product-id-checked", function () {
