...
<div class="col-md-9">
          ...
          <div class="card shadow mb-4">
            ...
            <div class="peer mt-2">
                        <form action="{{route('deletebrandofday')}}" class="actionDelete" method="post">
 ...
 Delete all selected Brands</button>
            ...
            <form role="form" action="#" method="post">
	          {{ csrf_field() }}
                ...
                <table class="table table-bordered" id="brandoftheday" style="width:100%">
                    <thead> 
                    <th>#</th>
                    <th>Brand Name</th>
                    <th>Sellel Name</th>
