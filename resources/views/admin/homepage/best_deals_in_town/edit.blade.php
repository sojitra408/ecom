...
<div class="col-md-9">
  ...
  <div class="card shadow mb-4">
    ...
    <form role="form" action="{{ route('home.best_deals_in_town.update',$single->id) }}" method="post" enctype=multipart/form-data>
     {{ csrf_field() }}
     <div class="box-body">
            ...
            <?php $select=""; if(count($str_arr)>0 && !empty($str_arr)){
              ...
              <div class="form-group">
                ...
                <div class="form-group">
                 ...
                 <a href="{{route('home.best_deals_in_town.index')}}" class="btn btn-warning btn-sm">Back</a>
               </div>
