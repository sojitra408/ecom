...
<div class="col-md-9">
          ...
          <div class="card shadow mb-4">
            ...
            <form role="form" action="{{ route('home.other-text.update',$single->id) }}" method="post">
	          {{ csrf_field() }}
	              <div class="box-body">
          ...
          <input class="form-control" type="text" placeholder="Title2" name="title2" id="title"  value="{{$single->title2}}">
	            ...
	            <div class="form-group">
	              ...
	              <a href="{{route('home.other-text.index')}}" class="btn btn-warning btn-sm">Back</a>
	            </div>
