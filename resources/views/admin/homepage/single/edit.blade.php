...
<div class="col-md-9">
          <!-- Page Heading -->
          <h1 class="h3 mb-2 text-gray-800">Edit Home Products</h1>
         

          <!-- DataTales Example -->
          <div class="card shadow mb-4">
            <div class="card-header py-3">
              <h6 class="m-0 font-weight-bold text-primary">Home Products</h6>
            </div>
            <div class="peer mt-2">
                        <form action="{{route('deletehomesingle')}}" class="actionDelete" method="post">
	...
	@endforeach
            ...
            <form role="form" action="#" method="post">
	          {{ csrf_field() }}
                ...
                <table class="table table-bordered" id="homeproduct_table" style="width:100%">
                    <thead> 
                    <th>Id </th>
                    <th>Product Name</th>
                    <th>Brand Name</th> 
