...
.imagePreview {
  ...
  @if(!empty($single->image))
    ...
    background:url("{{asset('public/images/'.$single->image)}}");
...
<div class="col-md-9">
          <!-- Page Heading -->
          <h1 class="h3 mb-2 text-gray-800">Edit Other</h1>
          ...
          <div class="card shadow mb-4">
            ...
            <form role="form" action="{{ route('home.other.update',$single->id) }}" method="post">
	          {{ csrf_field() }}
	              <div class="box-body">
				...
				<div class="form-group">
				  ...
				  {{$single->description}}</textarea>
                                ...
                                <div class="form-group">
                                    ...
                                    <!-- <input type="file" class="form-control form-control-sm" id="image" name="image" value="{{$single->image}}"> -->
	            ...
	            <div class="form-group">
	              ...
	              <a href="{{route('home.other.index')}}" class="btn btn-warning btn-sm">Back</a>
	            </div>
