...
<div class="col-md-9">
          <!-- Page Heading -->
          <h1 class="h3 mb-2 text-gray-800">Index Other</h1>
                    ...
                    <tbody>
                        ...
                        foreach ($single as $page){?>
                          <tr>
                            ...
                            <img width="50" src="{{asset('public/front/assets/images/'.$page->image)}}"></img>
                            ...
                            <th><!--<a href="{{route('user.detail',$page->id)}}" class="btn btn-primary btn-sm"><i class="fas fa-eye"></i>--></a>
                              <a href="{{route('home.other.edit',$page->id)}}" class="btn btn-success btn-sm"><i class="fas fa-edit"></i></a>
