...
<div class="col-md-9">
          <!-- Page Heading -->
          <h1 class="h3 mb-2 text-gray-800">Edit Brand Square</h1>
         

          <!-- DataTales Example -->
          <div class="card shadow mb-4">
            <div class="card-header py-3">
              <h6 class="m-0 font-weight-bold text-primary">Brand Square</h6>
            </div>
            <div class="peer mt-2">
                        <form action="{{route('deletebrandSquare')}}" class="actionDelete" method="post">
 ...
 Delete all selected Brands</button>
	                ...
	                <span class="badge badge-secondary mr-2">{{$brand->Brand->brand_name}}</span>    
            ...
            <form role="form" action="#" method="post">
	          {{ csrf_field() }}
				...
				<label>Select up to 10 Brands</label>
                ...
                <table class="table table-bordered" id="brandSquare" style="width:100%">
                    <thead> 
                    <th>#</th>
                    <th>Brand Name</th>
                    <th>Sellel Name</th>
