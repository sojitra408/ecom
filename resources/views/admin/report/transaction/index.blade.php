...
@section('content')
        <div class="container-fluid">
          ...
          <div class="card shadow mb-4">
            ...
            <!-- <div> -->
             ...
             <div class="row">
                <div class="col-sm-6">
              <form role="form" action="{{ route('transaction.export') }}" method="post">
                {{ csrf_field() }}
        ...
        $('#endDate').datepicker({
            ...
            minDate: function () {
              ...
              <form role="form" action="{{ route('admin.transactionreport.status') }}" method="get">
                {{ csrf_field() }}
                 <!-- @include('includes.messages') -->
                <div class="row"> 
                      <div class="form-group">
                        <label for="form">Payment Type</label>
                        <select name="payment_type" class="form-control form-control-sm custom-select-sm">
                          ...
                          data.addRows([
                              ...
                              @php
                                foreach($result as $product) {
                                  ...
                                  echo "['".$product->name."', '".$product->email."','".$product->mobile."','".$product->order_id."','".$product->order_date."','".$order_status1."',".$product->grand_total.",'".$product->payment_type."',],";
                          ...
                          ['Task', 'Hours per Day'],
                            ...
                            @php
                                ...
                                foreach($count_received_order_final as $received_order) {
                                    ...
                                    echo "['".$received_order->payment_type."', ".$received_order->total_order."],";
                                }
