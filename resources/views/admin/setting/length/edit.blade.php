...
@section('content')
        ...
        <div class="container-fluid">
          ...
          <!-- Page Heading -->
          <h1 class="h3 mb-2 text-gray-800">Edit Length</h1>
          ...
          <!-- DataTales Example -->
            <div class="card shadow mb-4">
                ...
                <form role="form" action="{{ route('length.update',$page->id) }}" method="post" enctype= multipart/form-data>
                    {{ csrf_field() }}
                    ...
                    @include('includes.messages')  
                        <div class="row">
                            ...
                            <div class="form-group">
                                    <label for="name">Length Name</label>
                            ...
                            <div class="col-lg-offset-3 col-lg-12">
                                <div class="form-group">
                                    ...
                                    @endif
                                    <a href="{{ route('admin.length') }}" class="btn btn-warning  btn-sm">Back</a>
                                </div> 
                            </div>
