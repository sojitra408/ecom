...
@section('content')
        ...
        <div class="container-fluid">
          ...
          <!-- Page Heading -->
          <h1 class="h3 mb-2 text-gray-800">Add Length</h1>
          ...
          <!-- DataTales Example -->
            <div class="card shadow mb-4">
                ...
                <form role="form" action="{{ route('length.save') }}" method="post" enctype= multipart/form-data>
                    {{ csrf_field() }}
                    ...
                    @include('includes.messages')  
                        <div class="row"> 
                            ...
                            <div class="form-group">
                                    <label for="title">Length Name</label>
