        ...
        <div class="container-fluid">
          ...
          <!-- DataTales Example -->
            <div class="card shadow mb-4">
                ...
                <form role="form" action="{{route('about.update',$page->id)}}" method="post" enctype= multipart/form-data>
                    {{ csrf_field() }}
                        ...
                        <div class="row"> 
                            ...
                            <div class="form-group">
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="date" class="form-control form-control-sm" id="date" name="date" value="{{$page->date}}">
                                </div> 
                                </div> 
