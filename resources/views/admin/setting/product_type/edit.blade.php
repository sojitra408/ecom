...
@section('content')
        ...
        <div class="container-fluid">
          ...
          <!-- Page Heading -->
          <h1 class="h3 mb-2 text-gray-800">Edit Product Type</h1>
          ...
          <!-- DataTales Example -->
            <div class="card shadow mb-4">
                ...
                <form role="form" action="{{ route('product_type.update',$page->id) }}" method="post" enctype= multipart/form-data>
                    {{ csrf_field() }}
                        ...
                        <div class="row">
                            ...
                            <div class="col-lg-offset-3 col-lg-12">
                                <div class="form-group">
                                    ...
                                    @endif
                                    <a href="{{ route('admin.product_type') }}" class="btn btn-warning  btn-sm">Back</a>
                                </div> 
                            </div>
