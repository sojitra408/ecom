        ...
        <div class="container-fluid">
          ...
          <!-- DataTales Example -->
            <div class="card shadow mb-4">
                ...
                <form role="form" action="{{ route('setting.update',$page->id) }}" method="post">
                    {{ csrf_field() }}
                        ...
                        <div class="row"> 
                            ...
                            <div class="form-group">
								...
								<div class="form-group">
                                    ...
                                    <!-- <textarea class="form-control form-control-sm" id="description" name="description">{{$page->description}}</textarea> -->
