...
.imgAdd
{
  ...
  font-size:15px;
        ...
        <div class="container-fluid">
          ...
          <!-- Page Heading -->
          <h1 class="h3 mb-2 text-gray-800">Add Size</h1>
          ...
          <!-- DataTales Example -->
            <div class="card shadow mb-4">
                ...
                <form role="form" action="{{ route('guide.save') }}" method="post" enctype="multipart/form-data">
                    {{ csrf_field() }}
                        ...
                        <div class="row"> 
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-lg-offset-3 col-lg-6"> 
                                  ...
                                  <select class="form-control form-control-sm myselect" id="size_category" name="size_category">
                                        @if(!$pages->isEmpty())
                                        @foreach($pages as $sel )
