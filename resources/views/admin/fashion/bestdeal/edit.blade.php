          ...
          <div class="card shadow mb-4">
            <div class="card-header py-3">
              <h6 class="m-0 font-weight-bold text-primary">Head Top Sell Category</h6>
                ...
                <div class="peer mt-2">
                        <form action="{{route('deletefashion.category')}}" class="actionDelete" method="post">
	...
	@endforeach
            ...
            <form role="form" action="#" method="post">
	          {{ csrf_field() }}
                ...
                <table class="table table-bordered" id="fashiontop_sell_table" style="width:100%">
                    <thead> 
                    <th>Id</th>
                    <th>Category Name</th>
...
function checkboxSelect(id) {
       ...
       $("#overlay").fadeIn(300);
		...
		$.ajax({
		   type:'GET',
		   url:"{{ route('saveFashion_category') }}",
		   data:{
