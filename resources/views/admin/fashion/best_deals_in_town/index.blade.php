...
<div class="col-md-9">
          <!-- Page Heading -->
          <h1 class="h3 mb-2 text-gray-800">Best Deals In Town</h1>
                        ...
                        foreach ($single as $page){?>
                          <tr>
                            ...
                            <th><!--<a href="{{route('user.detail',$page->id)}}" class="btn btn-primary btn-sm"><i class="fas fa-eye"></i>--></a>
                              <a href="{{route('fashion.best_deals_in_town.edit',$page->id)}}" class="btn btn-success btn-sm"><i class="fas fa-edit"></i></a>
