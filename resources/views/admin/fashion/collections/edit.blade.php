...
<div class="col-md-9">
          <!-- Page Heading -->
          <h1 class="h3 mb-2 text-gray-800">Edit Collections</h1>
          ...
          <div class="card shadow mb-4">
            ...
            <form role="form" action="{{ route('fashion.collections.update',$slider->id) }}" method="post">
	          {{ csrf_field() }}
	              <div class="box-body">
          ...
          <?php $str_arr=explode(',',$slider->collections_id); 
