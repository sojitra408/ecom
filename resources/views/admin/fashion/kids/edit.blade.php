...
<div class="col-md-9">
          <!-- Page Heading -->
          <h1 class="h3 mb-2 text-gray-800">Edit Fashion Kids Products</h1>
         

          <!-- DataTales Example -->
          <div class="card shadow mb-4">
            <div class="card-header py-3">
              <h6 class="m-0 font-weight-bold text-primary">Fashion Kids Products</h6>
            </div>
            
            <div class="peer mt-2">
                        <form action="{{route('deletefashion.kids')}}" class="actionDelete" method="post">
 ...
 Delete all selected Fashion Kids</button>
        				</form>
	                </div>
            <div class="peer mt-2">
	...
	@endforeach
            ...
            <form role="form" action="#" method="post">
	          {{ csrf_field() }}
                ...
                <table class="table table-bordered" id="fashionkids_table" style="width:100%">
                    <thead> 
                    <th>Id </th>
                    <th>Product Name</th>
                    <th>Brand Name</th> 
...
function checkboxSelect(id) {
 ...
 $("#overlay").fadeIn(300);
		...
		$.ajax({
		   type:'GET',
		   url:"{{ route('saveFashionKidsProducts') }}",
		   data:{
