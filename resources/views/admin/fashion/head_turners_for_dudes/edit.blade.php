...
<div class="col-md-9">
          <!-- Page Heading -->
          <h1 class="h3 mb-2 text-gray-800">Edit Fashion Head Turners For Dudes</h1>
         

          <!-- DataTales Example -->
          <div class="card shadow mb-4">
            <div class="card-header py-3">
              <h6 class="m-0 font-weight-bold text-primary">Fashion Head Turners For Dudes</h6>
            </div>
            <form role="form" action="{{ route('fashion.fashion_head_turners_for_dudes.update',$slider->id) }}" method="post">
	          {{ csrf_field() }}
	              <div class="box-body">
