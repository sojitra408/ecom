...
@section('content')
        ...
        <div class="container-fluid">
          ...
          <!-- Page Heading -->
          <h1 class="h3 mb-2 text-gray-800">Edit Attribute</h1>
          ...
          <div class="card shadow mb-4">
            ...
            <form role="form" action="{{ route('attributes.update',$project->id) }}" method="post">
	          {{ csrf_field() }}
	              <div class="box-body">
	            <div class=" col-lg-8 py-2">
                  ...
                  <input type="text" class="form-control" id="attributes_name" name="attributes_name"  value="{{ $project->attributes_name }}">
                </div>
                ...
                <div class="sizes">
					...
					<div class="col-sm-4">
						...
						<label for="color_code" class="control-label col-form-label">Color #Code </label>

						<input type="text" name="color_code[]" id="color_code" class="form-control"  value="" placeholder=""/>
					</div>
