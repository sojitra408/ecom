...
<div class="col-md-9">
          ...
          <div class="card shadow mb-4">
            ...
            <form role="form" action="{{ route('food.best_deals_in_town_two.update',$single->id) }}" method="post" enctype=multipart/form-data>
	          {{ csrf_field() }}
	              <div class="box-body">
          ...
          @foreach ($all_category as $key => $value)
           ...
           @endif
	            ...
	            <div class="form-group">
	              ...
	              <a href="{{route('food.best_deals_in_town_two.index')}}" class="btn btn-warning btn-sm">Back</a>
	            </div>
