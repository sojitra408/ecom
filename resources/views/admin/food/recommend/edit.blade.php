...
<div class="col-md-9">
          ...
          <div class="card shadow mb-4">
            ...
            <div class="peer mt-2">
                        <form action="{{route('deletefoodTotRecommends')}}" class="actionDelete" method="post">
	...
	@endforeach
            ...
            <form role="form" action="#" method="post">
	          {{ csrf_field() }}
                ...
                <table class="table table-bordered" id="foodRecommends_table" style="width:100%">
                    <thead> 
                    <th>Id</th>
                    <th>Product Name</th>
                    <th>Brand Name</th> 
...
function checkboxSelect(id) {
       ...
       $("#overlay").fadeIn(300);
		...
		$.ajax({
		   type:'GET',
		   url:"{{ route('food_tot_recommend_update') }}",
		   data:{
