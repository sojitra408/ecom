...
<div class="col-md-9">
          ...
          <div class="card shadow mb-4">
            ...
            <div class="peer mt-2">
                        <form action="{{route('deletefoodsellcate')}}" class="actionDelete" method="post">
	...
	@endforeach
            ...
            <form role="form" action="#" method="post">
	          {{ csrf_field() }}
                ...
                <table class="table table-bordered" id="food_sell_top_sell_table" style="width:100%">
                    <thead> 
                    <th>Id</th>
                    <th>Category Name</th>
...
function checkboxSelect(id) {
       ...
       $("#overlay").fadeIn(300);
		...
		$.ajax({
		   type:'GET',
		   url:"{{ route('food_sell_top_sell_table_update') }}",
		   data:{
