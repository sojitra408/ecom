...
<div class="col-md-9">
          <!-- Page Heading -->
          <h1 class="h3 mb-2 text-gray-800">Edit Food Head Turners For Stoppers In City</h1>
         

          <!-- DataTales Example -->
          <div class="card shadow mb-4">
            <div class="card-header py-3">
              <h6 class="m-0 font-weight-bold text-primary">Food Head Turners For Stoppers In City</h6>
            </div>
            <form role="form" action="{{ route('food.food_head_turners_for_stoppers_in_city.update',$slider->id) }}" method="post">
	          {{ csrf_field() }}
	              <div class="box-body">
          ...
          @endforeach
           ...
           @endif
	            ...
	            <div class="form-group">
	              ...
	              <a href="{{route('food.collections.edit')}}" class="btn btn-warning btn-sm">Back</a>
	            </div>
