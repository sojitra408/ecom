...
<div class="col-md-9">
          ...
          <h1 class="h3 mb-2 text-gray-800">Edit Food Kids Products</h1>
          ...
          <div class="card shadow mb-4">
            ...
            <div class="card-header py-3">
              ...
              <h6 class="m-0 font-weight-bold text-primary">Food Kids Products</h6>

            </div>
            
            <div class="peer mt-2">
                        <form action="{{route('deletefoodKids')}}" class="actionDelete" method="post">
...
<!--<div id="selected_brand"></div>-->
            <form role="form" action="#" method="post">
	          ...
	          {{ csrf_field() }}
                ...
                <table class="table table-bordered" id="foodkids_table" style="width:100%">
...
function checkboxSelect(id) {
  ...
  $("#overlay").fadeIn(300);
		...
		$.ajax({
		   ...
		   url:"{{ route('saveFoodKidsProducts') }}",
