        ...
        <div class="multisteps-form">
          ...
          <div class="row">
            <div class="col-12 col-lg-12 ml-auto mr-auto mb-4">
               <div class="multisteps-form__progress">
                ...
                <a href="{{url('admin/product-create/images')}}" style="padding-left: 55px;" class="multisteps-form__progress-btn js-active" title="Images">Images </a>
          ...
          <div class="row">
            <div class="col-12 col-lg-12 m-auto">
              <form class="multisteps-form__form" method="post" action="{{url('admin/product-create/images')}}" enctype="multipart/form-data">
              @csrf
                        ...
                        @if(!$allimages->isEmpty())
                          @foreach($allimages as $allImg )
                            <div class="col-lg-6" style="margin-top:40px">
                              <input value="{{$allImg->id}}" name="image[]" type="checkbox">
                              <img style="margin-left: 20px;" src="{{$allImg->url}}" height="100" width="100" />
                            </div>
                          @endforeach
                        @endif 
                    </div>
