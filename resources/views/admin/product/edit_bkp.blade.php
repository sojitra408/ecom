...
.slider.round:before {
 ...
 @endforeach
                    ...
                    <div class="form-group row">
                      ...
                      <div class="col-md-4">
                        <input name="ean_code" class="form-control form-control-sm" id="ean_code" value="{{$product->ean_code}}" required labelcol="2" type="text" maxlength="13">
                      </div>
                    </div> 
      ...
      <!--                </div> -->
                    ...
                    <div class="form-group row">
					 ...
					 <label for="desclaimer" class="col-md-2 control-label text-left">Disclaimer<span class="m-l-5 text-red">*</span></label>
                      <div class="col-md-4">
                        <textarea name="desclaimer" class="form-control form-control-sm" required id="desclaimer"  labelcol="2" type="text" maxlength="500">{{$product->desclaimer}}</textarea>
                      </div>
                      @endif
                      
                      @if($product->category_id == 3 || $product->category_id == 19)
                      <label for="cuisine" class="col-md-2 control-label text-left">Item Form<span class="m-l-5 text-red">*</span></label>
      ...
      <!--                </div>-->
                    ...
                    <div class="form-group row">
                    @if($product->category_id == 19)
                      <label for="cuisine" class="col-md-2 control-label text-left">Cuisine<span class="m-l-5 text-red">*</span></label>
                    ...
                    @if($product->category_id == 19)
                  <label for="cuisine" class="col-md-2 control-label text-left">Flavour<span class="m-l-5 text-red">*</span></label>
                  ...
                  <div class="form-group row">
                      ...
                      <label for="cuisine" class="col-md-2 control-label text-left">Pattern<span class="m-l-5 text-red">*</span></label>
                      
                     <div class="col-md-4">
                        <select class="form-control form-control-sm" name="pattern" id="seller" required>
                     ...
                     <label for="cuisine" class="col-md-2 control-label text-left">Fit<span class="m-l-5 text-red">*</span></label>
                      
                     <div class="col-md-4">
                        <select class="form-control form-control-sm" name="fit" id="seller" required>
                  ...
                  <div class="form-group row">
                      ...
                      <label for="cuisine" class="col-md-2 control-label text-left">Length<span class="m-l-5 text-red">*</span></label>
                      
                     <div class="col-md-4">
                        <select class="form-control form-control-sm" name="lengths" id="seller" required>
                     ...
                     <label for="cuisine" class="col-md-2 control-label text-left">Neck<span class="m-l-5 text-red">*</span></label>
                      
                     <div class="col-md-4">
                        <select class="form-control form-control-sm" name="neck" id="seller" required>
                  ...
                  <div class="form-group row">
                      ...
                      <label for="cuisine" class="col-md-2 control-label text-left">Sleeve<span class="m-l-5 text-red">*</span></label>
                      
                     <div class="col-md-4">
                        <select class="form-control form-control-sm" name="sleeve" id="seller" required>
                     ...
                     <label for="cuisine" class="col-md-2 control-label text-left">Rise<span class="m-l-5 text-red">*</span></label>
                      
                     <div class="col-md-4">
                        <select class="form-control form-control-sm" name="rise" id="seller" required>
                  ...
                  <div class="form-group row">
                      ...
                      <label for="cuisine" class="col-md-2 control-label text-left">Hair Type<span class="m-l-5 text-red">*</span></label>
                      
                     <div class="col-md-4">
                        <select class="form-control form-control-sm" name="hair_type" id="seller" required>
                     ...
                     <label for="cuisine" class="col-md-2 control-label text-left">Skin Type<span class="m-l-5 text-red">*</span></label>
                      
                     <div class="col-md-4">
                        <select class="form-control form-control-sm" name="skin_type" id="seller" required>
                  ...
                  <div class="form-group row">
                      ...
                      <label for="cuisine" class="col-md-2 control-label text-left">Material<span class="m-l-5 text-red">*</span></label>
                     ...
                     <label for="cuisine" class="col-md-2 control-label text-left">Scent<span class="m-l-5 text-red">*</span></label>
                ...
                @if($product->category_id == 2)
                  <div class="form-group row">
                      ...
                      <label for="cuisine" class="col-md-2 control-label text-left">Fabric<span class="m-l-5 text-red">*</span></label>
                      
                     <div class="col-md-4">
                        <select class="form-control form-control-sm" name="fabric" id="seller" required>
