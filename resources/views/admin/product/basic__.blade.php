  ...
  <div class="container-fluid"> 
    ...
    <input type="radio" value="{{$cat->id}}" name="category" id="option{{$c}}" autocomplete="off" required  > {{$cat->name}}
                    ...
                    <div class="form-group row">
                      ...
                      <div class="col-md-4">
                        <input name="ean_code" class="form-control form-control-sm" id="ean_code" value="" required labelcol="2" type="text" maxlength="13">
                      </div>
                    </div> 
                    ...
                    <div class="form-group row">
                      ...
                      <div class="col-md-10">
                        <textarea name="short_description" class="form-control form-control-sm" id="short_description"  value="" labelcol="2" type="text" maxlength="180"></textarea>
                      </div>
                    </div>
                    <div class="form-group row">
                      ...
                      <div class="col-md-10">
                        <textarea name="long_description" class="form-control form-control-sm" id="long_description"  value="" labelcol="2" type="text" maxlength="2000"></textarea>
                      </div> 
                      ...
                      <div class="col-md-4">
                        ...
                        <select class="form-control form-control-sm" multiple name="usp[]" id="usp" required>
                          ...
                          @foreach($usp as $sel )
                            ...
                            <option value="{{$sel->id}}">{{$sel->code}}</option>
                      ...
                      @if(!$attributes->isEmpty())
                        @foreach($attributes as $attr )
                          <div class="col" style="margin-top:10px">
                            <input value="{{$attr->id}}" id="attributes_{{$attr->id}}" name="attributes[]" type="checkbox">
