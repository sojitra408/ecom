...
@section('content')
  ...
  <div class="container-fluid"> 
    <!-- Page Heading -->
    <h1 class="h3 mb-2 text-gray-800">Add Variant Values</h1> 
    <!-- DataTales Example -->
        ...
        <!--multisteps-form-->
          ...
          <div class="row">
            <div class="col-12 col-lg-12 m-auto">
              <form  method="post" action="{{route('variantvalue.store')}}">
              @csrf
             
               
                  <h3>Add Variant Values</h3>
                    ...
                    <div class="form-group row">
					  ...
					  @if(!$values->isEmpty())
						...
						<div class="form-check form-check-inline">
						  <input class="form-check-input" name="values[]" type="checkbox" id="inlineCheckbox_{{$var->id}}" value="{{$var->id}}">
						  <label class="form-check-label" for="inlineCheckbox_{{$var->id}}">{{$var->value_name}}</label>
						</div>
						@endforeach
                          @endif
					...
					<input type="hidden" value="{{$var_id}}" name="variant_id" >
