...
<div class="col-md-9">
          ...
          <div class="card shadow mb-4">
            ...
            <div class="peer mt-2">
                        <form action="{{route('deletebeauty.single')}}" class="actionDelete" method="post">
	...
	@endforeach
            ...
            <form role="form" action="#" method="post">
	          {{ csrf_field() }}
                ...
                <table class="table table-bordered" id="beautyproduct_table" style="width:100%">
                    <thead> 
                    <th>Id </th>
                    <th>Product Name</th>
                    <th>Brand Name</th> 
