                                                        ...
                                                        <tbody>
                                                            ...
                                                            <tr>
                                                                <td align="center"
                                                                    ...
                                                                    We have noted your purchase and your goodie parcel
                                                                    number is {{ $orders->order_id }}<br><br>
                                                                    Our workforce is working hard to curate it and we'll
                                                                    update you once its ready to be sent to the port for
                                                                    dispatch.<br><br>
                                                                </td>
                                                            </tr>
