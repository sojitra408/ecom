<head>
  ...
  <title>My Account |  {{ $pageTitle }} </title>
...
<meta name="robots" content="noindex, nofollow">
 ...
 <!-- Bootstrap 3.3.6 -->
  <link href="{!! asset('public/users/bootstrap/css/bootstrap.min.css') !!}" media="all" rel="stylesheet" type="text/css" />
  <link href="{!! asset('public/users/bootstrap/css/styles.css') !!}" media="all" rel="stylesheet" type="text/css" />
  <link href="{!! asset('public/users/css/dropzone.css') !!}" media="all" rel="stylesheet" type="text/css" />
  <link href="{!! asset('public/users/css/custom.ilyas.css') !!}" media="all" rel="stylesheet" type="text/css" />
  {{--fancybox--}}
