        ...
        x.VERSION = "1.13.1", x.DEFAULTS = {
            ...
            createDropdown: function() {
                var b = this.multiple || this.options.showTick ? " show-tick" : "",
                    ...
                    e = this.options.liveSearch ? '<div class="bs-searchbox slideRight"><input type="text" class="form-control" id="searchcontrolbox" placeholder="Search" role="textbox" aria-label="Search"></div>' : "",
            ...
            clickListener: function() {
                ...
                d.data("spaceSelect", !1), this.$button.on("keyup", function(a) {
                    ...
                    b.$menuInner[0].scrollTop !== b.selectpicker.view.scrollTop && (b.$menuInner[0].scrollTop = b.selectpicker.view.scrollTop), b.options.liveSearch ? "" : ""
                    ...
                    if (b.multiple && 1 !== b.options.maxOptions && d.stopPropagation(), d.preventDefault(), !b.isDisabled() && !f.parent().hasClass(u.DISABLED)) {
                        ...
                        !b.multiple || b.multiple && 1 === b.options.maxOptions ? b.$button.focus() : b.options.liveSearch && b.$searchbox.focus(blur), l && (i != c(b.$element[0]) && b.multiple || j != b.$element.prop("selectedIndex") && !b.multiple) && (k = [h, n.prop("selected"), i], b.$element.triggerNative("change"))
                    }
